...
const QuestionQualityDashboard: React.FC<QuestionQualityDashboardProps> = ({ onClose }) => {
  ...
  return (
    <ModalShell
      ...
      subtitle="Monitor and improve your question bank"
      onClose={onClose}
      maxWidth="5xl"
      tone="purple"
      ...
      actions={(
            <button
              ...
              onClick={loadData}
              disabled={isLoading}
              className="min-h-11 min-w-11 bg-white/20 hover:bg-white/30 p-2 rounded-lg transition-colors disabled:opacity-50"
              title="Refresh data"
